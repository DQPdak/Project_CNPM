      ...
      <div className="dashboard-grid">
        <div className="main-column">
          <div className="card">
            ...
            <p className="card-desc">
              Quản lý phân quyền tài khoản, cấu hình đơn giá và xem log.
            </p>
        ...
        <div>
          <div className="widget-admin">
            <h2 className="widget-title-emerald">Báo cáo dữ liệu độc giả</h2>
            <p className="widget-desc-emerald">
              Xem log nhập liệu CSV, đồng bộ hóa dữ liệu xếp hạng kỳ phát hành.
            </p>
